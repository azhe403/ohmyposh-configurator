...
import { Settings, Palette, Code, Sliders, Globe, Info, ChevronDown, ChevronRight } from 'lucide-react';
...
function AvailableProperties({ properties }: AvailablePropertiesProps) {
    ...
    <div className="mt-2 border border-[#0f3460] rounded bg-[#0f0f23]">
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-medium">Available Properties ({properties.length})</span>
        </div>
              ...
              >
                <div className="flex items-start gap-2">
                  <code
                    ...
                    title="Click to copy"
                  >
                    {copiedProp === prop.name ? '✓ Copied!' : prop.name}
                  </code>
